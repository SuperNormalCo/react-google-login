...
export default () => {
  const { addScopes } = useGoogleLogin({
    clientId,
    onScopeAddSuccess: (res) => (console.log(res)),
    onScopeAddFailure: (err) => (console.log(err))
  })
  ...
  return (
    <div>
      ...
      <br />
      <br />
      <button onClick={() => addScopes('https://www.googleapis.com/auth/analytics')}>Add scopes</button>
      <br />
      <br />
      <GoogleLogin
        clientId={clientId}
